...
public class MyStoresParams extends  GeneralParams {

    @MyAnnotation("riorder_call_param_value")
    @MyAnnotationSequence(7)
    private String id;

    public MyStoresParams(){

    }


    public MyStoresParams(String udid, String phone, String language, String deviceType, String carrier, String osVersion, String name, String id){
